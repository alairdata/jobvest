    ...
    <header className="py-3.5 px-3 sm:px-7 bg-white border-b border-warm-border flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="w-9 h-9 rounded-[10px] border border-stone-200 bg-white flex items-center justify-center cursor-pointer text-stone-400 hover:bg-stone-50 hover:text-stone-600 transition-colors"
        >
